...
const key='5b589c5afafd8a424f7f9d8741f792e6'
...
function getSearchWeather(latitude,longitude) {
    let api= `http://api.openweathermap.org/data/2.5/lat=${latitude}&log=${longitude}&appid=${key}`
}
